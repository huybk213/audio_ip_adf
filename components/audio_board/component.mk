...
COMPONENT_ADD_INCLUDEDIRS += ./lyrat_v4_3_byt
COMPONENT_SRCDIRS += ./lyrat_v4_3_byt
endif

ifdef CONFIG_ESP_LYRAT_V4_3_BOARD_BYT_V102
COMPONENT_ADD_INCLUDEDIRS += ./lyrat_v4_3_byt_v102
COMPONENT_SRCDIRS += ./lyrat_v4_3_byt_v102
endif
...
ifdef CONFIG_BOARD_TRO_GIANG
COMPONENT_ADD_INCLUDEDIRS += ./tro_giang
COMPONENT_SRCDIRS += ./tro_giang
endif
